...
add_action ('genesis_before_entry_content', 'laura_quick_links');

function laura_quick_links() {

  ?>
  <div class="quick-links"><?php the_field('quick_links');

  if ( !empty(get_field('quick_image'))) {
    ?>
    <a href="<?php the_field('quick_image') ?>"><img src="<?php the_field('quick_image') ?>"></a>
    <?php
  }
  ?>
  </div>
